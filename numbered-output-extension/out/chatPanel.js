...
class ChatPanel {
    static createOrShow(extensionUri, ollamaService, contextManager, historyManager) {
        ...
        const panel = vscode.window.createWebviewPanel('numberedOutput.chatView', 'AI Assistant Chat', column || vscode.ViewColumn.One, {
            enableScripts: true,
            localResourceRoots: [
    ...
    static addFileContext(fileName, content) {
        if (ChatPanel.currentPanel) {
            ChatPanel.currentPanel._contextManager.addFileContext(fileName, content);
        }
    }
    constructor(panel, extensionUri, ollamaService, contextManager, historyManager) {
        this._disposables = [];
