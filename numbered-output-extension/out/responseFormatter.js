...
class ResponseFormatter {
     ...
     */
    static enhanceCodeBlocks(content) {
     ...
     */
    static validateNumberedFormat(content) {
        const issues = [];
        const lines = content.split('\n');
        ...
        const hasInstructions = lines.some(line => this.shouldBeNumbered(line.trim()) && !this.isAlreadyNumbered(line.trim()));
