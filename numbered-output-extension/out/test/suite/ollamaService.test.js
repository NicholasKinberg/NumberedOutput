...
suite('OllamaService Test Suite', () => {
    let ollamaService;
    setup(() => {
        ollamaService = new ollamaService_1.OllamaService();
    });
    ...
    test('Should handle connection error gracefully', async function () {
        ...
        const invalidService = new ollamaService_1.OllamaService();
        invalidService.baseUrl = 'http://invalid-url:99999';
    ...
    test('Should handle API errors', async function () {
        ...
        ollamaService.baseUrl = 'http://localhost:99999';
        const messages = [
    ...
    test('Should format response content', () => {
        ...
        const formatted = ollamaService.formatResponse(rawContent);
