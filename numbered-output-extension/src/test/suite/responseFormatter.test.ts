...
Test the code`;
        ...
        const output = ResponseFormatter.formatResponse(input);
...
\`\`\``;
        ...
        const output = ResponseFormatter.enhanceCodeBlocks(input);
    ...
    test('Should clean excessive blank lines', () => {
        const input = 'Line 1\n\n\n\n\nLine 2';
        const output = ResponseFormatter.cleanResponse(input);
...
3. Third step`;
        ...
        const result = ResponseFormatter.validateNumberedFormat(validInput);
...
5. Fifth step`;
        ...
        const result = ResponseFormatter.validateNumberedFormat(invalidInput);
...
Then test it`;
        ...
        const output = ResponseFormatter.format(input);
